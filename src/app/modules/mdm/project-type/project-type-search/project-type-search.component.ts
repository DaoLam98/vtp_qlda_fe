...
@Component({
  selector: 'app-project-type-search',
  standalone: false,
  templateUrl: './project-type-search.component.html'
})
export class ProjectTypeSearchComponent {
  Utils = Utils;
  configForm: Config;
    ...
    this.columns.push(
      {
        ...
        title: (e: ProjectTypeModel) => `${e.code || ''}`,
        cell: (e: ProjectTypeModel) => `${e.code || ''}`,
      ...
      },
      {
        ...
        title: (e: ProjectTypeModel) => `${e.name || ''}`,
        cell: (e: ProjectTypeModel) => `${e.name || ''}`,
      ...
      },
      {
        columnDef: 'status',
        header: 'status',
        title: (e: ProjectTypeModel) => `${e.status ? this.utilsService.getEnumValueTranslated(BaseStatusEnum, e.status) : ''}`,
        cell: (e: ProjectTypeModel) => `${e.status ? this.utilsService.getEnumValueTranslated(BaseStatusEnum, e.status) : ''}`,
    ...
    this.buttons.push(
      {
        ...
        display: (e: ProjectTypeModel) => true,
      ...
      },
      {
        ...
        display: (e: ProjectTypeModel) => true,
        disabled: (e: ProjectTypeModel) => e?.status === 'APPROVED',
        header: 'common.table.action.title',
        alignHeader: AlignEnum.CENTER
      },
      {
        ...
        display: (e: ProjectTypeModel) => true,
        disabled: (e: ProjectTypeModel) => e?.status === 'REJECTED',
        header: 'common.table.action.title',
        alignHeader: AlignEnum.CENTER
      },
    );
