...
export class AssetsModel extends BaseModel {
  ...
  assetGroupId: number | null = null;
  assetGroupName: string | null = null;
  ...
  constructor(form: FormGroup | number) {
    ...
    if (form instanceof FormGroup) {
      ...
      this.assetGroupId = Utils.getFormControlValue(form, 'assetGroupId');
      this.assetGroupName = Utils.getFormControlValue(form, 'assetGroupName');
    } else {
      this.id = form;
    }
  }
