...
import {FORM_CONFIG} from 'src/app/modules/mdm/period-type/period-type-search/period-type-search.config';
...
@Component({
  selector: 'app-period-type-search',
  standalone: false,
  templateUrl: './period-type-search.component.html'
})
export class PeriodTypeSearchComponent {
  Utils = Utils;
  configForm: Config;
